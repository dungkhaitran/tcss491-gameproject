class abandonCastle {
    constructor(game, x, y) {
        ...
        // spritesheet
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/background/abandon-castle.png");
    }
    update() {
    ...
    draw(ctx) {
        ctx.drawImage(this.spritesheet, 0, 0, this.spritesheet.width / 1, this.spritesheet.height, 
