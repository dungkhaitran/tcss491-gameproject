class firstLevel {
    ...
    loadLevel(x, y) {
        ...
        for(var i = 1; i <= 1; i++){
          this.game.addEntity(
            new DarkMage(this.game, 1000 * i, 375)
          );
        }
        ...
        for(var i = 1; i <= 1; i++){
          this.game.addEntity(
            new BirdMan(this.game, 600 * i, 525)
          );
        }
        ...
        for(var i = 1; i <= 1; i++){
          this.game.addEntity(
            new FlyingDemon(this.game, 1300 * i, 50)
          );
        }
        ...
        for(var i = 1; i <= 10; i++){
          this.game.addEntity(
            new NightmareHorse(this.game, 1100 * i, 450, FACING_SIDE.LEFT)
          );
        }
